...
public class CustomerController {
    ...
    public ResponseEntity<CustomerInfo> findCustomerByID(@PathVariable("customerId") Long id) {
        log.info("Http request, GET /api/customers/{customerId} with variable: " + id);
...
//        CustomerInfo customer = customerService.findByCity(city);
//        return new ResponseEntity<>(customer, HttpStatus.OK);
//    }
}
